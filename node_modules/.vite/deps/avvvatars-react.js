...
MersenneTwister.prototype.init_by_array = function(init_key, key_length) {
  ...
  for (; k; k--) {
    s2 = this.mt[i2 - 1] ^ this.mt[i2 - 1] >>> 30;
    this.mt[i2] = (this.mt[i2] ^ (((s2 & 4294901760) >>> 16) * 1664525 << 16) + (s2 & 65535) * 1664525) + init_key[j2] + j2;
    this.mt[i2] >>>= 0;
    i2++;
    j2++;
    if (i2 >= this.N) {
...
MersenneTwister.prototype.genrand_res53 = function() {
  var a2 = this.genrand_int32() >>> 5, b2 = this.genrand_int32() >>> 6;
  return (a2 * 67108864 + b2) * (1 / 9007199254740992);
};
var AleaGen = function() {
  ...
  _proto.next = function next() {
    var c2 = this.c, s0 = this.s0, s1 = this.s1, s2 = this.s2;
    var t2 = 2091639 * s0 + c2 * 23283064365386963e-26;
    this.s0 = s1;
    this.s1 = s2;
    return this.s2 = t2 - (this.c = t2 | 0);
  };
  _proto.copy = function copy(f2, t2) {
    t2.c = f2.c;
    t2.s0 = f2.s0;
    t2.s1 = f2.s1;
    t2.s2 = f2.s2;
...
var _templateObject;
var ShapeWrapper = j("span")(_templateObject || (_templateObject = _taggedTemplateLiteralLoose(["\n  display: inline-flex;\n  align-items: center;\n  vertical-align: middle;\n\n  color: #", ";\n"])), function(p2) {
  return p2.color || "currentColor";
});
...
var Wrapper = j("div")(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteralLoose(["\n  width: ", "px;\n  height: ", "px;\n  border-radius: ", "px;\n  background-color: #", ";\n\n  ", "\n\n  box-sizing: border-box;\n\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  user-select: none;\n\n  &:hover {\n    z-index: 3;\n  }\n\n  ", "\n"])), function(p2) {
  return p2.size;
}, function(p2) {
  return p2.size;
}, function(p2) {
  return p2.$radius || p2.size;
}, function(p2) {
  return p2.color;
}, function(p2) {
  return p2.$border && "border: " + p2.$borderSize + "px solid " + p2.$borderColor + ";";
}, function(p2) {
  return p2.$shadow && "\n    box-shadow: \n      0px 3px 8px rgba(18, 18, 18, 0.04),  \n      0px 1px 1px rgba(18, 18, 18, 0.02);\n  ";
});
var Text = j("p")(_templateObject2 || (_templateObject2 = _taggedTemplateLiteralLoose(['\n  /* Reset */\n  margin: 0;\n  padding: 0;\n  text-align: center;\n  box-sizing: border-box;\n\n  font-family: -apple-system, BlinkMacSystemFont, "Inter", "Segoe UI", Roboto, sans-serif;\n\n  font-size: ', "px;\n  color: #", ";\n  line-height: 0;\n  text-transform: uppercase;\n  font-weight: 500;\n"])), function(p2) {
  return Math.round(p2.size / 100 * 37);
}, function(p2) {
  return p2.color;
});
